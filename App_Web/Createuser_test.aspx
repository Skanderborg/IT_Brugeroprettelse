    ...
    <div class="container">
      ...
      <div class="form-group">
        <div class="row">
          ...
          <div class="col-6">
            <label for="TxbVistnavn">Medarbejderens viste navn som også danner e-mail adresse:</label><label class="requiredfield">*</label>
...
<%--      <div class="form-group">
      ...
      <div class="form-group">
        <label for="CbCoworkerSamaccount">Vælg medarbejderens nærmeste kollega i samme afdeling og med samme Q-drev:</label><label class="requiredfield">*</label>
...
<%--      <div class="form-group">
      ...
      <div class="form-group">
        <asp:label runat="server" ID="ErrSkype" for="RbIsSkype">Skal medarbejderen have et personligt Skype lokalnummer?</asp:label><label class="requiredfield">*</label>
      ...
      <asp:Panel runat="server" ID="panelOpusLonPersonale" Visible="false">
        ...
        <small id="educapersonaleTips" class="form-text text-muted">Adgang til Educa Personale.</small>
      </div>
      <asp:Panel ID="panel_educapersonale" runat="server" Visible="false">
        <div class="form-group">
        ...
        <div class="form-group">
        <asp:label runat="server" ID="errRBIsRakat" for="RBIsRakat">RAKAT e-handelssystem?</asp:label><label class="requiredfield">*</label>
        <asp:RadioButtonList ID="RBIsRakat" runat="server" Width="100" RepeatDirection="Horizontal" OnSelectedIndexChanged="RBIsRakat_SelectedIndexChanged" AutoPostBack="true">
          <asp:ListItem Text="Ja"></asp:ListItem>
          <asp:ListItem Text="Nej"></asp:ListItem>
        </asp:RadioButtonList>
        <small id="RBIsRakathelptext" class="form-text text-muted">Oprettelse videresendes automatisk til systemadministrator for RAKAT</small>
      </div>
      <asp:Panel ID="panel_Rakat" runat="server" Visible="false">
        <div class="form-group">
          <asp:label runat="server" ID="errRbRakatRole" for="RbRakatRole">Rolle:</asp:label><label class="requiredfield">*</label>
          <asp:RadioButtonList ID="RbRakatRole" runat="server" Width="500px" RepeatDirection="Vertical" OnSelectedIndexChanged="RbRakatRole_SelectedIndexChanged" AutoPostBack="true">
            <asp:ListItem Text="Bruger A - Kigge adgang" Value="A"></asp:ListItem>
            <asp:ListItem Text="Bruger B - Indkøber der kan handle og kontere sin ordre" Value="B"></asp:ListItem>
            <asp:ListItem Text="Bruger C - Indkøber der kan afgive ordre, men ikke kontere den" Value="C"></asp:ListItem>
            <asp:ListItem Text="Bruger D - Konteringsansvarlig for Bruger C" Value="D"></asp:ListItem>
          </asp:RadioButtonList>
        </div>
      </asp:Panel>
      <asp:Panel ID="panel_rakat_profitomkoststed" runat="server" Visible="false">
        <div class="form-group">
          <telerik:RadTextBox runat="server" ID="Txb_rakat_profitomkoststed" EmptyMessage="Angiv profitcenter/omkostningsted" width="100%" />
          <small id="Txb_rakat_profitomkoststed_help" class="form-text text-muted">Angiv den OPUS profitcenterknude/omkostningssted der skal konteres på.</small>
        </div>
      </asp:Panel>
      <asp:Panel ID="panel_rakat_konteringsansvarlig" runat="server" Visible="false">
        <div class="form-group">
          <telerik:RadTextBox runat="server" ID="Txb_rakat_konteringsansvarlig" EmptyMessage="Angiv konteringsansvarlig" width="100%" />
          <small id="Txb_rakat_konteringsansvarlig_help" class="form-text text-muted">Angiv den konteringsansvarlige til RAKAT.</small>
        </div>
      </asp:Panel>
        

        <div class="form-group">
          <asp:label runat="server" ID="errKMDelev" for="RbIsTargit">KMD Elev?</asp:label><label class="requiredfield">*</label>
